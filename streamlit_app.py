...
list(map(lambda col: st.session_state['ratings_df'].__setitem__(col, st.session_state['ratings_df'][col] if col in st.session_state['ratings_df'].columns else 0), TRIP_TYPES))
